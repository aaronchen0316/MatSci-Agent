...
Both commands preflight `gpt-5.4-mini` through the configured proxy and need MP plus LLM credentials. They require a clean `multi-agent` checkout synchronized with `origin/main` and write evidence under the ignored artifact root.
